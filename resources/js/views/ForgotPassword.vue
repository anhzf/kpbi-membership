  ...
  <v-container fluid class="fill-height">
    <v-row justify="center" align="stretch">
      <v-card width="320" class="elevation-4 mb-16">
        <v-form ref="ForgotPasswordForm" @submit.prevent="resetPassword" :disabled="formDisabled">
          ...
          <v-card-text class="px-4">
            <v-text-field label="Email" placeholder="user@example.com" v-model="email" outlined />
          </v-card-text>
