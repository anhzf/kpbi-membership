  ...
  methods: {
    login: function login() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var loginData, login, _this$$route$query$re;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return Object(_util_Auth__WEBPACK_IMPORTED_MODULE_1__["Login"])(loginData);
              ...
              case 4:
                ...
                _this.$emit('contentLoading', false);
                ...
                if (login.success) {
                  ...
                  _this.$router.push((_this$$route$query$re = _this.$route.query.redirect) !== null && _this$$route$query$re !== void 0 ? _this$$route$query$re : {
                    name: 'AccountSettings'
                  });
                } else {
                  _this.$emit('noticeError', login);
                }
    ...
    [
      _vm.$route.query.message
        ? _c("v-row", { attrs: { justify: "center" } }, [
            _c("h5", { staticClass: "text-h5" }, [
              _vm._v(_vm._s(_vm.$route.query.message))
            ])
          ])
        : _vm._e(),
      _vm._v(" "),
      _c(
        ...
        [
          _c(
            "v-card",
            { staticClass: "elevation-4 mb-16", attrs: { width: "320" } },
            [
              _c(
                "v-form",
                {
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            [
                              _c("span", { staticClass: "text-headline5" }, [
                                _vm._v("Login")
                              ])
                            ]
                          )
