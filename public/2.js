...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      email_prodi: null,
      email_kaprodi: null,
      requiredRules: _util_Validator__WEBPACK_IMPORTED_MODULE_2__["required"],
      emailRules: _util_Validator__WEBPACK_IMPORTED_MODULE_2__["email"]
    };
  },
  methods: {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                if (register.success) {
                  ...
                  _this.$emit('notice', {
                    message: 'Silahkan coba login untuk melanjutkan'
                  }); // Redirect user
